...
I'm Abhishek — a detail-obsessed engineer with a love for clean code, intuitive interfaces, and deep packet inspection. My current focus is **DeltaPerf AI**, a network latency and anomaly detection tool powered by Python and AI. I thrive at the intersection of performance analytics, terminal UI design, and creative branding.
...
- **Projects**: Explore my latest tools, including DeltaPerf AI — a robust CLI utility for network engineers.
...
- 🔍 **DeltaPerf AI**: Real-time latency analysis, anomaly detection, and AI-powered summaries.
...
- 📦 **Cross-Platform Ready**: Built with robust path handling and file management for any OS.
...
> 💡 _“Tools should be as elegant as they are powerful.”_ — That’s the philosophy behind everything I build.

Thanks for stopping by — and feel free to star, share, or fork anything that inspires you!
